  ...
  return (
    <div className="container mx-auto left-[-1px] flex flex-col items-center gap-10 bg-brandblack p-[100px_0_150px] max-w-[1440px] px-10">
      <div className="relative inline-flex flex-col items-center gap-[15px]">
        <p className="relative text-transparent font-roc-grotesk text-[46px] font-bold tracking-[0.02px] leading-[50.6px] -mt-[1px] text-center">
      ...
      <div className="relative flex flex-wrap justify-center items-start gap-[20px_20px]">
