    ...
    return (
        <div className=" flex flex-col items-center gap-[60px] bg-[#9adbe5] mx-[10px] rounded-[40px] p-[120px_0] ">
            <div className="relative inline-flex flex-col items-center gap-[15px]">
                <div className="relative text-brandblack font-roc-grotesk text-[40px] lg:text-[46px] font-bold tracking-[0.02px] leading-[50.6px] -mt-[1px] text-center lg:whitespace-nowrap">Why Design Chics?</div>
                <p className="text-wrapper-37 relative text-brandblack font-karla text-[16px] lg:text-[20px] font-normal leading-[28px] text-center lg:whitespace-nowrap">Being a part of Design Chics Community gives you access to:</p>
            </div>
