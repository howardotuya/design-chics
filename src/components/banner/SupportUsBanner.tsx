...
const SupportUsBanner = () => {
  return (
    <>
      <div className=" flex flex-col items-center gap-[60px] bg-brandblack pt-[60px] lg:pt-[100px]">
        <div className="relative inline-flex flex-col items-center gap-[30px] px-10">
          <div className="relative inline-flex flex-col items-center gap-[15px]">
            <div className="relative text-[#fffcf5] font-roc-grotesk text-[28px] md:text-[40px] lg:text-[46px] font-bold tracking-[0.02px] leading-[31px] md:leading-[44px] lg:leading-[50.6px] -mt-[1px] text-center lg:w-[589px]">
              Like to support us?
            </div>
            <p className="relative text-[#fffcf5] font-karla md:text-[18px] lg:text-[22px] font-normal leading-[140%] text-center max-w-[322px] md:max-w-[490px] lg:max-w-[740px]">
              Support Design Chics Community to help us reach more African women
              in Design and invest in empowering more women.
            </p>
          </div>
          <div className="relative flex flex-col md:flex-row justify-center items-start gap-[30px] w-full">
            ...
            <Link
              href="https://mail.google.com/mail/u/0/?fs=1&to=info@fordesignchics.com&tf=cm"
              target="_blank"
              className="to-purple bg-[#9adbe5] flex items-center justify-center text-black rounded-full box-border gap-[8.25px] p-[18px_16px] relative w-full lg:w-[280px]"
            >
        ...
        <div className="w-full relative">
          <div className=" absolute bottom-0 right-0 md:bottom-[30%] md:right-[7%] lg:bottom-[38%] lg:right-[6%] h-[65px] w-[235px]">
          ...
          <div className=" absolute  top-[30%] left-[9%] md:top-[30%] md:left-[14%] h-[67px] w-[149px] transform rotate-180">
