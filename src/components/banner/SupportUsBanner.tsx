...
const SupportUsBanner = () => {
    return (
        <div className=" flex flex-col items-center gap-[60px] bg-[#0b0a0a] p-[60px_0_0] ">
            <div className="relative inline-flex flex-col items-center gap-[30px]">
                ...
                {/* <div className="relative flex flex-col lg:flex-row justify-center items-start gap-[30px] w-full">
                    <button className="relativeflex items-center justify-center gap-[8.25px] border-2 border-[#9adbe5] rounded-3xl p-[18px_16px] w-full lg:w-[280px]">
                        <div className="relative text-[#9adbe5] font-roc-grotesk text-[16px] font-bold -mt-[2px]">DONATE</div>
                    </button>
                    <button className="flex items-center justify-center bg-[#9adbe5] rounded-3xl box-border gap-[8.25px] p-[18px_16px] relative w-full lg:w-[280px]">
                        <div className="relative mt-[-1.03px]  font-roc-grotesk text-[16px] font-bold leading-normal w-fit">BECOME A PARTNER</div>
                    </button>
                </div> */}
            </div>
            <div className="relative lg:h-[830.8px] w-full xl:w-[1440px]">
                <div className="relative bg-[url('https://c.animaapp.com/unzonupS/img/491-removebg-2.png')] bg-cover bg-no-repeat lg:h-[831px] w-full lg:w-[1439px] left-[1px]">
                    <div className="absolute hidden top-[506px] left-[1109px] h-[65px] w-[235px]">
                    ...
                    <div className="absolute hidden top-[269px] left-[329px] h-[67px] w-[149px] transform rotate-180">
